...
coverage: ## check code coverage quickly with the default Python
	coverage run --source et-micc-build -m pytest
	coverage report -m
	coverage html
...
#-------------------------------------------------------------------------------
# Install package et_micc_build in the current Python
# environment.
install: clean dist
	pip install dist/$(module_name)-$(version)-py3-none-any.whl

#-------------------------------------------------------------------------------
# Uninstall package et_micc_build from current Python environment
uninstall:
